...
Follow these commands to clone, build, and source the workspace on a clean environment:
...
## 4. Motion Sequence & Pose Configuration
...
## 5. Known Issues & Technical Assumptions
